    ...
    <div class="mx-8 grid grid-cols-1 lg:grid-cols-3 gap-4" v-if="fetchedData">
      <UCard class="card p-6" variant="soft">
        <div class="flex flex-col gap-10">
          <div class="flex flex-col gap-2">
            <h2 class="subheading text-center">Funzione di Partenza</h2>
          ...
          <div class="flex flex-col gap-2">
            <h2 class="subheading text-center">Funzione Inversa</h2>
      ...
      <UCard class="card p-6 lg:col-span-2 h-fit" variant="soft">
        <template #header>
          <h2 class="subheading">Grafico Completo</h2>
      ...
      <UCard class="card p-6 lg:col-span-3" variant="soft">
        <template #header>
          <div class="flex flex-col gap-2">
            <h2 class="subheading">Studio della Funzione</h2>
        ...
        <div class="flex flex-col gap-6">
          ...
          <!-- Dominio -->
          <div class="flex flex-col gap-2">
            <h3 class="subheading">Dominio</h3>
            <p class="subp">
          ...
          <!-- Codominio -->
          <div class="flex flex-col gap-2">
            <h3 class="subheading">Codominio</h3>
            <p class="subp">
          ...
          <!-- Iniettività -->
          <div class="flex flex-col gap-2">
            <h3 class="subheading">Iniettività</h3>
            <p class="subp">
          ...
          <!-- Suriettività -->
          <div class="flex flex-col gap-2">
            <h3 class="subheading">Suriettività</h3>
            <p class="subp">
          ...
          <!-- Biettività -->
          <div class="flex flex-col gap-2">
            <h3 class="subheading">Biettività</h3>
            <p class="subp">
          ...
          <!-- Monotonia -->
          <div class="flex flex-col gap-2">
            <h3 class="subheading">Monotonia</h3>
            <p class="subp">
          ...
          <!-- Limiti -->
          <div class="flex flex-col gap-2">
            <h3 class="subheading">Limiti</h3>
            <div class="subp space-y-1">
              <p>
                <span class="subp">Per x → -∞:</span>
          ...
          <!-- Asintoti -->
          <div class="flex flex-col gap-2">
            <h3 class="subheading">Asintoti</h3>
            <div class="subp space-y-1">
              <p
                v-if="
                ...
                "
              >
                <span class="subp">Verticali:</span> Nessuno
              </p>
              <p
                v-if="
                ...
                "
              >
                <span class="subp">Orizzontali:</span> Nessuno
              </p>
              <p
                v-if="
                  fetchedData.studio_della_funzione.asintoti.obliqui.length ===
                  0
                "
              >
                <span class="subp">Obliqui:</span> Nessuno
              </p>
            </div>
          </div>
          ...
          <!-- Punti Notevoli -->
          <div class="flex flex-col gap-2">
            <h3 class="subheading">Punti Notevoli</h3>
            <div class="subp space-y-1">
              <p
                v-if="
                ...
                "
              >
                <span class="subp">Intersezione asse x:</span>
                ({{
                  fetchedData.studio_della_funzione.punti_notevoli
                    .intersezione_assi.x
                }}, 0)
              ...
              <p
                ...
                "
              >
                <span class="subp">Intersezione asse y:</span>
                (0,
                {{
                  fetchedData.studio_della_funzione.punti_notevoli
                    .intersezione_assi.y
          ...
          <!-- Descrizione Grafico -->
          <div class="flex flex-col gap-2">
            <h3 class="subheading">Grafico Qualitativo</h3>
            <p class="subp">
          ...
          <div class="flex flex-col gap-2">
            <h3 class="subheading">Spiegazione Completa</h3>
            <p class="subp">
